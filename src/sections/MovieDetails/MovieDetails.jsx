...
const MovieDetails = (props) => {
    ...
    const castSliderNavigationId = 'movie-details-slider-navigation'
    ...
    const reviewItems = [
        {
            name: 'Aniket Roy',
            subtitle: 'From India',
            description: 'This movie was recommended to me by a very dear friend who went for the movie by herself. ' +
        ...
        },
        {
            name: 'Swaraj',
            subtitle: 'From India',
            description: 'A restless king promises his lands to the local tribals in exchange of a stone ' +
    ...
    return (
        ...
        >
            ...
            <div className="movie-details__main">
                ...
                <div className="movie-details__panel">
                    <header className="movie-details__panel-header movie-details__panel-header--large-gap-y">
